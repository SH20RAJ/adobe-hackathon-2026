...
def create_brand_icon(size):
    ...
    dot_y = margin + dot_r
    draw.ellipse([dot_x - dot_r, dot_y - dot_r, dot_x + dot_r, dot_y + dot_r], fill=(39, 194, 129, 255), outline=(20, 20, 20, 255), width=max(1, int(size * 0.015)))
...
def create_og_image():
    ...
    draw.text((80, 220), "Autonomous Brand AI-Readiness & Search Optimization", font=font_sub, fill=(240, 240, 240, 255))
    draw.text((80, 265), "Auditing AI Discoverability (ACPI) and On-site Retention (CRS) for Modern Answer Engines", font=font_small, fill=(160, 160, 160, 255))
    ...
    draw.text((80, 555), "Adobe University Hackathon 2026 · Round 3 CRP · agentskills.io Specification", font=font_small, fill=(140, 140, 140, 255))
