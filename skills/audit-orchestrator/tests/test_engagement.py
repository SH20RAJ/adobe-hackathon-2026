...
class EngagementTests(unittest.TestCase):
    def test_strong_ctas_are_healthy(self):
        findings, evidence = analyze(
            "<h1>Platform</h1><p>"
            + ("Useful product information " * 20)
            + "</p><a href='/demo'>Request a demo</a><a href='/trial'>Start free trial</a>"
        )
    ...
    def test_contact_form_is_healthy(self):
        findings, evidence = analyze(
            "<h1>Contact sales</h1><form><label for='email'>Work email</label><input id='email'><button type='submit'>Send request</button></form>"
        )
        self.assertNotIn("F-019", evidence)
    ...
    def test_weak_ctas_produce_low_finding(self):
        findings, evidence = analyze(
            "<h1>Information</h1><p>"
            + ("Detailed content " * 30)
            + "</p><a href='/more'>Click here</a><a href='/x'>More</a>"
        )
    ...
    def test_article_without_cta_is_not_high_severity(self):
        findings, _ = analyze(
            ...
            + ("This is a long article about documentation and history. " * 20)
            + "</p></article>"
        )
    ...
    def test_navigation_only_links_are_ignored(self):
        findings, evidence = analyze(
            "<nav><a href='/pricing'>Pricing</a><a href='/contact'>Contact</a></nav><p>"
            + ("Content " * 45)
            + "</p><footer><a href='/privacy'>Privacy</a></footer>"
        )
        self.assertIn("F-019", evidence)
    ...
    def test_social_only_links_are_ignored(self):
        findings, evidence = analyze(
            "<h1>Brand</h1><p>" + ("Content " * 45) + "</p><a href='https://linkedin.com/company/example'>LinkedIn</a>"
        )
        self.assertIn("F-019", evidence)
    ...
    def test_multiple_action_categories_are_reported(self):
        parsed = HTMLContentExtractor()
        parsed.feed(
            "<h1>Platform</h1><p>Choose a plan.</p><a href='/pricing'>View pricing</a><a href='/download'>Download report</a><a href='/book'>Book a demo</a>"
        )
    ...
    def test_empty_and_hidden_links_are_ignored(self):
        findings, evidence = analyze(
            "<h1>Information</h1><p>"
            + ("Content " * 45)
            + "</p><a href='#'></a><a href='javascript:void(0)'>Continue</a><a style='display:none' href='/demo'>Request a demo</a>"
        )
        self.assertIn("F-019", evidence)
        self.assertEqual(evidence["F-019"]["cta_count"], 0)
